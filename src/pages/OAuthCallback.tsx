...
export function OAuthCallback() {
  ...
  return (
    <main className="grid min-h-screen place-items-center bg-paper p-4 text-ink">
      <Panel className="w-full max-w-md rounded-2xl p-6 text-center">
        <p className="text-xs font-black uppercase text-teal">Google OAuth</p>
        ...
        {error && (
          <Link
            className="mt-5 inline-flex min-h-10 items-center justify-center rounded-lg bg-teal px-4 py-2 text-sm font-bold text-white transition hover:bg-teal-dark"
            to="/login"
          >
            Voltar para login
          </Link>
